...
function init(){
  ...
  (function(){
    ...
    var MAT_ICONS=(function(){var A='#FFAE1F',A2='#E08900',I='#4EA8FF',G='#3ECF8E',C='#FF6B5E',P='#9B7BFF';return {
      spark:'<path d="M12 2l2.2 6.6a3 3 0 001.2 1.2L22 12l-6.6 2.2a3 3 0 00-1.2 1.2L12 22l-2.2-6.6a3 3 0 00-1.2-1.2L2 12l6.6-2.2a3 3 0 001.2-1.2z" fill="'+A+'"/><path d="M19 3l.7 2.3L22 6l-2.3.7L19 9l-.7-2.3L16 6l2.3-.7z" fill="'+A2+'"/>',
      star:'<path d="M12 3.2l2.5 5.1 5.6.8-4.1 4 .97 5.6L12 16.9 7.03 18.7 8 13.1 3.9 9.1l5.6-.8z" fill="'+A+'"/><path d="M12 3.2l2.5 5.1 5.6.8-4.1 4 .97 5.6L12 16.9z" fill="'+A2+'"/>',
      bolt:'<path d="M13 2L5 13h5l-1 9 9-12h-5l1-8z" fill="'+A+'"/><path d="M13 2l-1 8h5l-9 12 1-9H5z" fill="'+A2+'" opacity=".55"/>',
      leaf:'<path d="M20 4s.4 8-4.5 12.5C11.6 20 5 20 5 20s0-6.6 3.5-10.5C13 4.6 20 4 20 4z" fill="'+G+'"/><path d="M6 19C9 13 13 9 18 6" stroke="#0C0B09" stroke-width="1.4" fill="none" stroke-linecap="round"/>',
      heart:'<path d="M12 21S3 14.6 3 8.8C3 5.6 5.4 4 7.7 4c1.7 0 3.3.9 4.3 2.4C13 4.9 14.6 4 16.3 4 18.6 4 21 5.6 21 8.8 21 14.6 12 21 12 21z" fill="'+C+'"/><path d="M12 21S3 14.6 3 8.8C3 5.6 5.4 4 7.7 4c1.7 0 3.3.9 4.3 2.4V21z" fill="#E14A3E" opacity=".5"/>',
      target:'<circle cx="12" cy="12" r="9" fill="'+I+'" opacity=".18"/><circle cx="12" cy="12" r="9" fill="none" stroke="'+I+'" stroke-width="2"/><circle cx="12" cy="12" r="5" fill="none" stroke="'+I+'" stroke-width="2"/><circle cx="12" cy="12" r="1.8" fill="'+C+'"/>',
      rocket:'<path d="M14 3c4 0 7 3 7 7 0 0-3 6-8 9l-4-4C12 10 14 3 14 3z" fill="'+I+'"/><circle cx="14.5" cy="9.5" r="2" fill="#0C0B09"/><path d="M6 15c-1.5 1.2-2 5-2 5s3.8-.5 5-2z" fill="'+A+'"/>',
      moon:'<path d="M21 13A9 9 0 1111 3a7 7 0 0010 10z" fill="'+A+'"/><path d="M21 13A9 9 0 0111 3a7 7 0 0010 10z" fill="'+A2+'" opacity=".5"/>',
      sun:'<circle cx="12" cy="12" r="5" fill="'+A+'"/><g stroke="'+A+'" stroke-width="2" stroke-linecap="round"><path d="M12 2v3M12 19v3M2 12h3M19 12h3M4.9 4.9l2.1 2.1M17 17l2.1 2.1M19.1 4.9L17 7M7 17l-2.1 2.1"/></g>',
      flame:'<path d="M12 3s6 4.5 6 10a6 6 0 01-12 0c0-2.5 1.5-4 1.5-4s.2 2.3 2.2 2.3C9.9 8.6 12 6 12 3z" fill="'+C+'"/><path d="M12 21a3.5 3.5 0 003.5-3.5c0-2-1.5-3-1.5-3s-.3 1.7-2 1.7c0-1.7 1-3 1-4.7C10 10 9 12 9 14.5A3.5 3.5 0 0012 21z" fill="'+A+'"/>',
      trophy:'<path d="M7 4h10v3a5 5 0 01-10 0z" fill="'+A+'"/><path d="M7 5H3.5v1A3.5 3.5 0 007 9.5M17 5h3.5v1A3.5 3.5 0 0117 9.5" fill="none" stroke="'+A2+'" stroke-width="1.6"/><path d="M10 14h4v3h-4z" fill="'+A2+'"/><path d="M8 21h8v-1a2 2 0 00-2-2h-4a2 2 0 00-2 2z" fill="'+A+'"/>',
      brain:'<path d="M9 4a3.2 3.2 0 00-3.2 3.2A3 3 0 004.5 13a3 3 0 002.2 4.2A3 3 0 0012 19V4a3 3 0 00-3 0z" fill="'+P+'"/><path d="M15 4a3.2 3.2 0 013.2 3.2A3 3 0 0119.5 13a3 3 0 01-2.2 4.2A3 3 0 0112 19V4a3 3 0 013 0z" fill="'+P+'" opacity=".55"/>',
      diamond:'<path d="M6 3h12l3.5 5.5L12 21 2.5 8.5z" fill="'+I+'"/><path d="M2.5 8.5h19L12 21z" fill="'+I+'" opacity=".55"/>',
      book:'<path d="M5 4a2 2 0 012-2h12v17H7a2 2 0 00-2 2z" fill="'+A+'"/><path d="M5 21a2 2 0 012-2h12v3H7a2 2 0 01-2-2z" fill="'+A2+'"/><path d="M9 6h7M9 9h7" stroke="#0C0B09" stroke-width="1.2" stroke-linecap="round" opacity=".4"/>',
      compass:'<circle cx="12" cy="12" r="9" fill="'+I+'" opacity=".18"/><circle cx="12" cy="12" r="9" fill="none" stroke="'+I+'" stroke-width="2"/><path d="M15.5 8.5l-2.2 4.8-4.8 2.2 2.2-4.8z" fill="'+A+'"/><circle cx="12" cy="12" r="1.2" fill="'+C+'"/>'
    };})();
    var ORDER=['spark','star','bolt','leaf','heart','target','rocket','moon','sun','flame','trophy','brain','diamond','book','compass'];
    var grid=$('iconPickGrid');
    function svg(id, cls){ var p=MAT_ICONS[id]||MAT_ICONS.spark; return '<svg class="'+(cls||'')+'" viewBox="0 0 24 24">'+p+'</svg>'; }
    function current(){ var v=(state.set&&state.set.appIcon)||'spark'; return MAT_ICONS[v]?v:'spark'; } /* migrate old emoji -> spark */
    function applyIcon(id){
      var mk=svg(id,'brandSvg');
      var nl=document.querySelector('.navLogo'); if(nl) nl.innerHTML=mk;
