...
public class NativeAlarms {
 ...
 static PendingIntent pi(Context c,int code,JSONObject a){
   ...
   try{i.putExtra("habit",a.optString("h",""));i.putExtra("task",a.optString("task",""));i.putExtra("name",a.optString("n","Reminder"));i.putExtra("emoji",a.optString("e","🔔"));i.putExtra("body",a.optString("b","Time for your reminder."));i.putExtra("id",a.optString("c",String.valueOf(code)));}catch(Exception ignored){}
